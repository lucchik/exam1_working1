...
xst -ifn xst.scr
move myClockGenerator_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\myClockGenerator_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc myClockGenerator_exdes.ucf myClockGenerator_exdes

echo 'Running map'
map -timing -pr b myClockGenerator_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm myClockGenerator_exdes -w routed.ncd routed.vhd
cd ..
